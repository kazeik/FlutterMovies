...
class MovieTagSearchListPage extends StatefulWidget {
  final String keyWord;

  const MovieTagSearchListPage({Key key, this.keyWord}) : super(key: key);

  @override
  _MovieTagSearchListPageState createState() => _MovieTagSearchListPageState();
}

class _MovieTagSearchListPageState extends State<MovieTagSearchListPage>
