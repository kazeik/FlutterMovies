...
import 'package:android/jieshuo/movie_detail_item.dart';
    ...
    return GestureDetector(
      ...
      child: Card(
        child: PhysicalModel(
          ...
          child:MovieDetailItem(movie: widget.movie,coverColor: pageColor,index: widget.index,),
        ),
      ),
    );
  }
