  ...
  _initController() {
    switch (widget.playType) {
      ...
      case PlayType.fileId:
        controller = TencentPlayerController.network(null, playerConfig: PlayerConfig(auth: {"appId": 1251203810, "fileId": widget.dataSource}));
        break;
    }
  }
              ...
              !isLock && showCover ? Positioned(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Image.asset('images/tencentplayer/icon_back.png', width: 20, height: 20, fit: BoxFit.contain, color: Colors.white,
                    ),
                  ),
                ),
              ) : SizedBox(),
              ...
              showCover ? Align(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(isLock ? 'images/tencentplayer/player_lock.png' : 'images/tencentplayer/player_unlock.png', width: 38, height: 38,),
                  ),
                ),
              ): SizedBox(),
              /// 进度、清晰度、速度
              ...
              showCover ? Positioned(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Image.asset('images/tencentplayer/full_screen_on.png', width: 20, height: 20),
                  ),
                ),
              ) : SizedBox(),
            ],
